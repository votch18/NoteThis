!function () {
    "use strict";
    var e, t, n, i, r, o = tinymce.util.Tools.resolve("tinymce.ThemeManager"), l = tinymce.util.Tools.resolve("tinymce.EditorManager"), w = tinymce.util.Tools.resolve("tinymce.util.Tools"), d = function (e) {
        return !1 !== c(e)
    }, c = function (e) {
    ...
    }, p = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"), v = tinymce.util.Tools.resolve("tinymce.ui.Factory"), b = tinymce.util.Tools.resolve("tinymce.util.I18n"), s = function (e) {
    ...
    }, R = tinymce.util.Tools.resolve("tinymce.geom.Rect"), u = tinymce.util.Tools.resolve("tinymce.util.Delay"), C = function (e) {
        return function () {
            return e
        }
    }, k = C(!1), E = C(!0), H = {
        ...
        for (var n = 0, i = e.length; n < i; n++)if (t(e[n], n, e))return N.some(n);
        return N.none()
    }, Q = function (e, t) {
        ...
        return function (e) {
            var t, n, i, r, o, s = e.control, a = s.parents().filter("panel")[0], l = a.find("#" + d)[0], u = (t = f, n = d, w.grep(t, function (e) {
                return e.name === n
            })[0]);
        ...
        if (!1 === m(t) && n.skinUiCss ? _e.styleSheetLoader.load(n.skinUiCss, we(t)) : we(t)(), i = e.panel = v.create({
            ...
            var l = b.translate(["Powered by {0}", '<a href="https://www.tinymce.com/?utm_campaign=editor_referral&amp;utm_medium=poweredby&amp;utm_source=tinymce" rel="noopener" target="_blank" role="presentation" tabindex="-1">tinymce</a>']), u = t.getParam("branding", !0, "boolean") ? {
                type: "label",
                classes: "branding",
                html: " " + l
            } : null;
    ...
    var Pe = function () {
        var e = window, t = Math.max(e.pageXOffset, document.body.scrollLeft, document.documentElement.scrollLeft), n = Math.max(e.pageYOffset, document.body.scrollTop, document.documentElement.scrollTop);
        return {
            x: t,
            y: n,
    ...
    }, De = tinymce.util.Tools.resolve("tinymce.util.Class"), Ae = tinymce.util.Tools.resolve("tinymce.util.EventDispatcher"), Be = function (e) {
        var t;
    ...
    var Ie, Fe, Ue, Ve = /^([\w\\*]+)?(?:#([\w\-\\]+))?(?:\.([\w\\\.]+))?(?:\[\@?([\w\\]+)([\^\$\*!~]?=)([\w\\]+)\])?(?:\:(.+))?/i, je = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g, qe = /^\s*|\s*$/g, Ye = De.extend({
        init: function (e) {
            var o = this.match;
    ...
    var ct = et = De.extend(at), dt = function (e) {
    ...
    var At = function (e, t) {
        ...
        return i && (n.skinUiCss = i + "/skin.min.css", e.contentCSS.push(i + "/content" + (e.inline ? ".inline" : "") + ".min.css")), At(e, t), e.getParam("inline", !1, "boolean") ? Nt(e, t, n) : Ce(e, t, n)
    }, Ot = ct.extend({
        Mixins: [Ne], Defaults: {classes: "widget tooltip tooltip-n"}, renderHtml: function () {
        ...
        Mixins: [Ne], Defaults: {classes: "widget notification"}, init: function (e) {
            var t = this;
    ...
    var Xt, Jt = $t.extend({
        ...
        Defaults: {classes: "widget btn", role: "button"}, init: function (e) {
            ...
            var e, t, n = this, i = n._id, r = n.classPrefix, o = n.state.get("icon"), s = n.state.get("text"), a = "", l = n.settings;
        ...
        init: function (i) {
            ...
            r._super(i), i = r.settings, r.classes.add("combobox"), r.subinput = !0, r.ariaTarget = "inp", i.menu = i.menu || i.values, i.menu && (i.icon = "caret"), r.on("click", function (e) {
                ...
                if (r.statusLevel() && -1 !== e.target.className.indexOf(r.classPrefix + "status")) {
                    var n = r.statusMessage() || "Ok", i = t.text(n).show().testMoveRel(e.target, ["bc-tc", "bc-tl", "bc-tr"]);
            ...
            var e, t, n, i = this, r = i._id, o = i.settings, s = i.classPrefix, a = i.state.get("value") || "", l = "", u = "";
        ...
        init: function (e) {
            ...
            var e = this, t = e._id, n = e.classPrefix, i = e.state.get("text"), r = e.settings.icon ? n + "ico " + n + "i-" + e.settings.icon : "", o = e.settings.image ? " style=\"background-image: url('" + e.settings.image + "')\"" : "", s = "";
        ...
        postRender: function () {
            ...
            function c(e, t) {
                ...
                He.css(r, {top: 100 * n + "%"}), t || He.css(s, {
                    left: e.s + "%",
                    top: 100 - e.v + "%"
                }), o.style.background = cn({s: 100, v: 100, h: e.h}).toHex(), a.color().parse({s: e.s, v: e.v, h: e.h})
            }
        ...
        renderHtml: function () {
            var e, t = this._id, o = this.classPrefix, s = "#ff0000,#ff0080,#ff00ff,#8000ff,#0000ff,#0080ff,#00ffff,#00ff80,#00ff00,#80ff00,#ffff00,#ff8000,#ff0000";
        ...
        immutable: function () {
            ...
            return zn("required", r), zn("optional", o), Ln(s), function (t) {
                var n = Dn.keys(t);
        ...
        nu: Vn, detect: function (e, t) {
            var n = String(t).toLowerCase();
            return 0 === e.length ? Un() : Fn(e, n)
        }, unknown: Un
    }, qn = "Firefox", Yn = function (e, t) {
        return function () {
            return t === e
        }
    }, $n = function (e) {
    ...
    }, Jn = "Windows", Gn = "Android", Kn = "Solaris", Zn = "FreeBSD", Qn = function (e, t) {
        return function () {
            return t === e
        }
    }, ei = function (e) {
    ...
    }, si = /.*?version\/\ ?([0-9]+)\.([0-9]+).*/, ai = function (t) {
        return function (e) {
            return oi(e, t)
        }
    }, li = [{
    ...
    }, {name: "Opera", versionRegexes: [si, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: ai("opera")}, {
        name: "Firefox",
        versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/],
        search: ai("firefox")
    }, {
        name: "Safari", versionRegexes: [si, /.*?cpu os ([0-9]+)_([0-9]+).*/], search: function (e) {
    ...
    }, {name: "Android", search: ai("android"), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/]}, {
        name: "OSX",
        search: ai("os x"),
        ...
        search: ai("sunos"),
        versionRegexes: []
    }, {name: "FreeBSD", search: ai("freebsd"), versionRegexes: []}], ci = {
        browsers: H.constant(li),
        oses: H.constant(ui)
    }, di = function (e) {
        var t, n, i, r, o, s, a, l, u, c, d, f = ci.browsers(), h = ci.oses(), m = ii(f, e).fold(Xn.unknown, Xn.nu), g = ri(h, e).fold(ti.unknown, ti.nu);
        return {
            browser: m,
            os: g,
    ...
    }, xi = yi("true"), wi = yi("false"), _i = function (e, t, n, i, r) {
        ...
        Statics: {
            ...
            var t, n, i, r = this, o = window.tinymce ? window.tinymce.activeEditor : l.activeEditor, s = o.settings, a = e.filetype;
        ...
        recalc: function (e) {
            var t, n, i, r, o, s, a, l, u, c, d, f, h, m, g, p, v, b, y, x, w, _, R, C, k, E, H, S, M, T, P, W, N, D, A, B, O, z = [], L = Math.max, I = Math.min;
        ...
        var t = ["alignleft", "aligncenter", "alignright", "alignjustify"], r = "alignleft", e = [{
            text: "Left",
            icon: "alignleft",
            onclick: Yi(i, "alignleft")
        }, {text: "Center", icon: "aligncenter", onclick: Yi(i, "aligncenter")}, {
            text: "Right",
            icon: "alignright",
            onclick: Yi(i, "alignright")
        }, {text: "Justify", icon: "alignjustify", onclick: Yi(i, "alignjustify")}];
        ...
        return function () {
            ...
            l.on("init nodeChange", function (e) {
                var t, n, i, r, o = l.queryCommandValue("FontName"), s = (t = u, r = (n = o) ? n.toLowerCase() : "", w.each(t, function (e) {
            ...
            return {
                ...
                onPostRender: (s = n, a = t, function () {
                    ...
                    s.on("init nodeChange", function (e) {
                        var t, n, i, r;
                        if (t = s.queryCommandValue("FontSize"))for (i = 3; !r && 0 <= i; i--)n = er(t, i), r = tr(a, n, t);
        ...
        e.addMenuItem("blockformats", {
            text: "Blocks", menu: (t = e, n = i, w.map(n, function (e) {
                return {
                    text: e[0], onclick: Yi(t, e[1]), textStyle: function () {
        ...
        return dr(o ? ur(e, o) : (t = e, n = "insert", i = [{text: "-"}], r = w.grep(t.menuItems, function (e) {
            return e.context === n
        }), w.each(r, function (e) {
        ...
        (t = e).addMenuItem("undo", {
            ...
            cmd: "undo"
        }), n.addButton("redo", {tooltip: "Redo", onPostRender: pr(n, "redo"), cmd: "redo"})
    }, br = function (e) {
        var t, n;
        ...
        init: function (e) {
            ...
            var e, t, n = this, i = n.settings.forId, r = n.settings.html ? n.settings.html : n.encode(n.state.get("text"));
        ...
        Defaults: {border: 0, role: "menuitem"}, init: function (e) {
            ...
            var e, t = this, n = t._id, i = t.settings, r = t.classPrefix, o = t.state.get("text"), s = t.settings.icon, a = "", l = i.shortcut, u = t.encode(i.url);
    ...
    }), Tr = nn.extend({Defaults: {classes: "radio", role: "radio"}}), Pr = zt.extend({
        renderHtml: function () {
            var e = this, t = e.classPrefix;
    ...
    var Or = zt.extend({
        init: function (e) {
            ...
            e = m._minValue, t = m._maxValue, "v" === m.settings.orientation ? (n = "screenY", i = "top", r = "height", o = "h") : (n = "screenX", i = "left", r = "width", o = "w"), m._super(), function (o, s) {
                function t(e) {
                    var t, n, i, r;
                    t = Dr(t = (((t = m.value()) + (r = n = o)) / ((i = s) - r) + .05 * e) * (i - n) - n, o, s), m.value(t), m.fire("dragstart", {value: t}), m.fire("drag", {value: t}), m.fire("dragend", {value: t})
                }
                ...
                drag: function (e) {
                    var t = e[n] - u;
                    f = Dr(c + t, 0, d), l.style[i] = f + "px", h = s + f / d * (a - s), m.value(h), m.tooltip().text("" + m.settings.previewFilter(h)).show().moveRel(l, "bc tc"), m.fire("drag", {value: h})
                },
                stop: function () {
        ...
        Defaults: {classes: "widget btn splitbtn", role: "button"}, repaint: function () {
            ...
            var e, t, n = this, i = n._id, r = n.classPrefix, o = n.state.get("icon"), s = n.state.get("text"), a = n.settings, l = "";
