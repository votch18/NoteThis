!function () {
    "use strict";
    var t = tinymce.util.Tools.resolve("tinymce.PluginManager"), a = tinymce.util.Tools.resolve("tinymce.util.Tools"), s = function (t, e, n) {
        ...
        return function (t) {
            ...
            i.on("NodeChange", function (t) {
                var e = function (t, e) {
                    ...
                    return -1
                }(t.parents, u), n = -1 !== e ? t.parents.slice(0, e) : t.parents, r = a.grep(n, c(i));
