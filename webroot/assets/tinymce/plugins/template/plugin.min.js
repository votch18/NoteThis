!function () {
    ...
    var e = tinymce.util.Tools.resolve("tinymce.PluginManager"), t = function (e) {
    ...
    }), o = tinymce.util.Tools.resolve("tinymce.util.Tools"), c = tinymce.util.Tools.resolve("tinymce.util.XHR"), a = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"), i = function (e) {
        ...
        return Math.min(a.DOM.getViewPort().h, e.getParam("template_popup_height", 500))
    }, y = function (e, t) {
        if ((e = "" + e).length < t)for (var n = 0; n < t - e.length; n++)e = "0" + e;
        return e
    }, v = function (e, t, n) {
        var a = "Sun Mon Tue Wed Thu Fri Sat Sun".split(" "), r = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday Sunday".split(" "), l = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), c = "January February March April May June July August September October November December".split(" ");
    ...
    }, T = M, x = _, P = function (t, e, n) {
        var a, r, l = t.dom, c = t.selection.getContent();
        ...
        if (-1 === n.indexOf("<html>")) {
            ...
            -1 !== r.indexOf("=") && (r = (r = t.getParam("body_class", "", "hash"))[t.id] || ""), n = "<!DOCTYPE html><html><head>" + a + '</head><body class="' + r + '">' + n + "</body></html>"
        }
        n = T(t, n, p(t));
        ...
        if (e && 0 !== e.length)o.each(e, function (e) {
            ...
            items: [{
                ...
                items: [{
                    ...
                    label: "Templates",
                    items: {
                        type: "listbox", label: "Templates", name: "template", values: t, onselect: function (e) {
                            var t = e.control.value();
                            t.url ? c.send({
                                url: t.url, success: function (e) {
                                    D(n, a, r = e)
                                }
                            }) : (r = t.content, D(n, a, r)), a.find("#description")[0].text(e.control.value().description)
                        }
                    }
                }]
