!function () {
    "use strict";
    var e = tinymce.util.Tools.resolve("tinymce.PluginManager"), o = tinymce.util.Tools.resolve("tinymce.Env"), v = tinymce.util.Tools.resolve("tinymce.util.Tools"), w = function (e) {
    ...
    }, p = tinymce.util.Tools.resolve("tinymce.html.SaxParser"), r = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"), x = function (e, t) {
        ...
        return c = t, s = u.createFragment(c), "" !== l(s.firstChild) ? (o = t, n = u.createFragment(o).firstChild, {
            ...
            start: function (e, t) {
                if (a.source1 || "param" !== e || (a.source1 = t.map.movie), "iframe" !== e && "object" !== e && "embed" !== e && "video" !== e && "audio" !== e || (a.type || (a.type = e), a = v.extend(t.map, a)), "script" === e) {
                    var r = x(i, t.map.src);
                    if (!r)return;
                    a = {type: "script", source1: t.map.src, width: r.width, height: r.height}
                }
        ...
        var i, r, a, o, n, c, s
    }, g = tinymce.util.Tools.resolve("tinymce.util.Promise"), M = function (e) {
        var t = {
            mp3: "audio/mpeg",
            wav: "audio/wav",
            mp4: "video/mp4",
        ...
        return t || ""
    }, _ = tinymce.util.Tools.resolve("tinymce.html.Writer"), C = tinymce.util.Tools.resolve("tinymce.html.Schema"), S = r.DOM, F = function (e, t) {
        var r, i, a, o;
        for (r in t)if (a = "" + t[r], e.map[r])for (i = e.length; i--;)(o = e[i]).name === r && (a ? (e.map[r] = a, o.value = a) : (delete e.map[r], e.splice(i, 1))); else a && (e.push({
            name: r,
            value: a
        }), e.map[r] = a)
    }, k = function (e, t) {
        ...
        return u = e, l = S.createFragment(u), "" !== S.getAttrib(l.firstChild, "data-ephox-embed-iri") ? k(e, t) : (i = e, a = t, o = r, c = _(), p({
            ...
            start: function (e, t, r) {
                switch (e) {
                    ...
                    case"img":
                    case"iframe":
                        a.height !== undefined && a.width !== undefined && F(t, {width: a.width, height: a.height})
                }
                if (o)switch (e) {
                    case"video":
                        F(t, {poster: a.poster, src: ""}), a.source2 && F(t, {src: ""});
                        break;
                    case"iframe":
                        F(t, {src: a.source1});
                        break;
                ...
                if ("video" === e && o)for (var t = 1; t <= 2; t++)if (a["source" + t]) {
                    var r = [];
                    r.map = {}, s < t && (F(r, {
                        src: a["source" + t],
                ...
                if (a.poster && "object" === e && o && !n) {
                    var i = [];
                    i.map = {}, F(i, {src: a.poster, width: a.width, height: a.height}), c.start("img", i, !0)
                }
                c.end(e)
            }
        ...
        var c, s, u, l, m, d, h, p, f = b(r), g = y(r);
        ...
        return c ? (a = t, o = P(e), n = c, new g(function (t, e) {
            var r = function (e) {
                return e.html && (O[a.source1] = e), t({url: a.source1, html: e.html ? e.html : o(a)})
            };
        ...
        L(e, z)
    }, D = W, E = o.ie && o.ie <= 8 ? "onChange" : "onInput", I = function (r) {
        return function (e) {
        ...
        return function (e) {
            var t = e.html, r = a.find("#embed")[0], i = v.extend(j(w(o), t), {source1: e.url});
        ...
        e.insertContent(t), function (e, t) {
            ...
            for (r = 0; r < t.length; r++)for (i = a.length - 1; 0 <= i; i--)t[r] === a[i] && a.splice(i, 1);
        ...
        } : r.getAttribute("data-mce-object") ? j(w(e), e.serializer.serialize(r, {selection: !0})) : {};
        var u = {
            id: "mcemediasource", type: "textbox", flex: 1, name: "embed", value: function (e) {
            ...
            }(i), multiline: !0, rows: 5, label: "Source"
        };
        u[E] = function () {
            t = v.extend({}, j(w(i), this.value())), this.parent().parent().fromJSON(t)
        };
        var l = [{title: "General", type: "form", items: n}, {
            title: "Embed",
            type: "container",
            layout: "flex",
            direction: "column",
            ...
            padding: 10,
            spacing: 10,
            items: [{type: "label", text: "Paste your embed code below:", forId: "mcemediasource"}, u]
        }];
        0 < c.length && l.push({
            title: "Advanced",
            type: "form",
    ...
    }, K = tinymce.util.Tools.resolve("tinymce.html.Node"), Q = function (a, e) {
        if (!1 === t(a))return e;
        var o, n = _();
        return p({
            validate: !1, allow_conditional_comments: !1, special: "script,noscript", comment: function (e) {
                n.comment(e)
            }, cdata: function (e) {
                n.cdata(e)
            }, text: function (e, t) {
        ...
        d.on("preInit", function () {
            ...
            v.each("webkitallowfullscreen mozallowfullscreen allowfullscreen".split(" "), function (e) {
                ...
                for (var r, i, a, o, n, c, s, u, l = e.length; l--;)if ((r = e[l]).parent) {
                    ...
                    })), i.attr({style: r.attr("style")}), a = (o = r.attributes).length; a--;) {
                        var m = o[a].name;
