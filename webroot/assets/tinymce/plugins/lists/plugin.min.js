!function () {
    "use strict";
    var e = tinymce.util.Tools.resolve("tinymce.PluginManager"), d = tinymce.util.Tools.resolve("tinymce.dom.RangeUtils"), l = tinymce.util.Tools.resolve("tinymce.dom.TreeWalker"), n = tinymce.util.Tools.resolve("tinymce.util.VK"), p = tinymce.util.Tools.resolve("tinymce.dom.BookmarkManager"), v = tinymce.util.Tools.resolve("tinymce.util.Tools"), t = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"), o = function (e) {
        ...
        var n = d.getNode(e, t);
        return i(e) && r(n) ? {container: n, offset: t >= e.childNodes.length ? n.data.length : 0} : {
            container: e,
            offset: t
        }
    }, L = function (e) {
        var t = e.cloneRange(), n = N(e.startContainer, e.startOffset);
        t.setStart(n.container, n.offset);
        var o = N(e.endContainer, e.endOffset);
        return t.setEnd(o.container, o.offset), t
    }, S = t.DOM, b = function (r) {
        var i = {}, e = function (e) {
            var t, n, o;
            n = r[e ? "startContainer" : "endContainer"], o = r[e ? "startOffset" : "endOffset"], 1 === n.nodeType && (t = S.create("span", {"data-mce-type": "bookmark"}), n.hasChildNodes() ? (o = Math.min(o, n.childNodes.length - 1), e ? n.insertBefore(t, n.childNodes[o]) : S.insertAfter(t, n.childNodes[o])) : n.appendChild(t), n = t, o = 0), i[e ? "startContainer" : "endContainer"] = n, i[e ? "startOffset" : "endOffset"] = o
        };
    ...
    }, B = tinymce.util.Tools.resolve("tinymce.dom.DomQuery"), R = function (e) {
        ...
        getParentList: R, getSelectedSubLists: function (e) {
            var t, n, o, r = R(e), i = e.selection.getSelectedBlocks();
    ...
    }, A = tinymce.util.Tools.resolve("tinymce.Env"), P = t.DOM, x = function (e, t, n) {
        var o, r, i, a = P.createFragment(), s = e.schema.getBlockElements();
        if (e.settings.forced_root_block && (n = n || e.settings.forced_root_block), n && ((r = P.create(n)).tagName === e.settings.forced_root_block && P.setAttribs(r, e.settings.forced_root_block_attrs), f(t.firstChild, s) || a.appendChild(r)), t)for (; o = t.firstChild;) {
            var d = o.nodeName;
    ...
    }, _ = t.DOM, M = function (e, t, n, o) {
        var r, i, a, s, d;
        for (a = _.select('span[data-mce-type="bookmark"]', t), o = o || x(e, n), (r = _.createRng()).setStartAfter(n), r.setEndAfter(t), s = (i = r.extractContents()).firstChild; s; s = s.firstChild)if ("LI" === s.nodeName && e.dom.isEmpty(s)) {
            _.remove(s);
            break
        }
        ...
        if (t.length) {
            var n = b(e.selection.getRng()), o = void 0, r = void 0, i = E.getClosestListRootElm(e, e.selection.getStart(!0));
            for (o = t.length; o--;)for (var a = t[o].parentNode; a && a !== i;) {
        ...
        void 0 === u && (u = {});
        var e, t = c.selection.getRng(!0), m = "LI", n = E.getClosestListRootElm(c, c.selection.getStart(!0)), g = c.dom;
        ...
        var e = b(o.selection.getRng(!0)), r = E.getClosestListRootElm(o, o.selection.getStart(!0)), t = E.getSelectedListItems(o), n = v.grep(t, function (e) {
        ...
        var o, r, i, a;
        if (r = Z(e, n) ? n.firstChild : n, Z(i = e, a = t) && i.remove(a.firstChild, !0), !m(e, t, !0))for (; o = t.firstChild;)r.appendChild(o)
    }, te = function (e, t, n) {
        ...
        var r, i, a, s = e.dom;
        if (s.isEmpty(o))i = n, a = o, (r = e).dom.$(a).empty(), te(r.dom, i, a), r.selection.setCursorLocation(a); else {
            var d = b(t);
            te(s, n, o), e.selection.setRng(D(d))
        }
    }, oe = function (e, t) {
        var n, o, r, i = e.dom, a = e.selection, s = a.getStart(), d = E.getClosestListRootElm(e, s), l = i.getParent(a.getStart(), "LI", d);
        if (l) {
        ...
        return oe(e, t) || function (r, i) {
            var a = r.dom, e = r.selection.getStart(), s = E.getClosestListRootElm(r, e), d = a.getParent(e, a.isBlock, s);
            if (d && a.isEmpty(d)) {
                var t = L(r.selection.getRng(!0)), l = a.getParent(Y(r, t, i, s), "LI", s);
        ...
        o.on("BeforeExecCommand", function (e) {
            ...
            if ("indent" === n ? fe(o) && (t = !0) : "outdent" === n && K(o) && (t = !0), t)return o.fire("ExecCommand", {command: e.command}), e.preventDefault(), !0
        ...
        return function (e) {
            ...
            t.on("NodeChange", function (e) {
                var t = function (e, t) {
                    ...
                    return -1
                }(e.parents, a), n = -1 !== t ? e.parents.slice(0, t) : e.parents, o = v.grep(n, h);
        ...
        n = "advlist", o = (t = e).settings.plugins ? t.settings.plugins : "", -1 === v.inArray(o.split(/[ ,]/), n) && (e.addButton("numlist", {
            ...
            onPostRender: (r = e, function (e) {
                ...
                r.on("nodechange", function () {
                    var e = E.getSelectedListItems(r), t = 0 < e.length && s(e[0]);
                    n.disabled(t)
                })
            })
        })
