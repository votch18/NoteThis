    ...
    <div class="card-header" id="notes">
		<div class="navhead">
			<ul class="nav justify-content-center" id="notes_header">
				<li class='mr-auto'>
					<a class='nav-link text-truncate' href='#' id='prevTab2' >
					...
					<li class='ml-auto'>
						<a class='nav-link text-truncate' href='#' id='nextTab2' >
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <small id="genLink" class="form-text text-muted"><a href="#">Create link to share this note.</a>
                        </small>
                    </div>
                    <hr/>
